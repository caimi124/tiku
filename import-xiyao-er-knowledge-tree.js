...
const knowledgeTree = [
...

  {
    ...
    title: '第五章 心血管系统用药',
    children: [
      { code: '5.1', title: '第一节 抗心律失常药', children: [
      ...
      { code: '5.2', title: '第二节 抗高血压药', children: [
      ...
      { code: '5.3', title: '第三节 调节血脂药', children: [
  ...
  },
  {
    ...
    title: '第六章 血液系统用药',
    children: [
      { code: '6.1', title: '第一节 抗血栓药', children: [
      ...
      { code: '6.2', title: '第二节 抗出血药', children: [
      ...
      { code: '6.3', title: '第三节 抗贫血药', children: [
      ...
      { code: '6.4', title: '第四节 升白细胞药', children: [
        { code: '6.4.1', title: '考点1 代表药品与临床用药评价', importance: 4 },
      ]},
      { code: '6.5', title: '第五节 骨髓保护药', children: [
        { code: '6.5.1', title: '考点1 药物分类与临床用药评价', importance: 3 },
      ]}
    ]
  },

  {
    ...
    title: '第七章 泌尿系统用药',
    children: [
      { code: '7.1', title: '第一节 利尿药', children: [
      ...
      { code: '7.4', title: '第四节 治疗膀胱过度活动症用药', children: [
  ...
  },
  {
    ...
    title: '第八章 内分泌系统用药',
    children: [
      { code: '8.1', title: '第一节 下丘脑-垂体激素及相关药物', children: [
      ...
      { code: '8.2', title: '第二节 肾上腺糖皮质激素类药物', children: [
      ...
      { code: '8.3', title: '第三节 甲状腺激素类药物与抗甲状腺药物', children: [
      ...
      { code: '8.4', title: '第四节 胰岛素与其他影响血糖的药物', children: [
      ...
      { code: '8.5', title: '第五节 调节骨代谢药物', children: [
...

  {
    ...
    title: '第九章 抗感染药物',
    children: [
      { code: '9.1', title: '第一节 抗菌药物总论', children: [
      ...
      { code: '9.4', title: '第四节 β-内酰胺酶抑制剂及复方制剂', children: [
        { code: '9.4.1', title: '考点1 代表药品与作用机制', importance: 4 },
        { code: '9.4.2', title: '考点2 药物临床用药评价', importance: 4 },
      ]},
      { code: '9.5', title: '第五节 碳青霉烯类抗菌药物', children: [
        { code: '9.5.1', title: '考点1 代表药品与作用机制', importance: 5 },
        { code: '9.5.2', title: '考点2 药物临床用药评价', importance: 5 },
      ]},
      { code: '9.6', title: '第六节 其他β-内酰胺类抗菌药物', children: [
        { code: '9.6.1', title: '考点1 药物分类与作用机制', importance: 4 },
        { code: '9.6.2', title: '考点2 药物临床用药评价', importance: 4 },
        { code: '9.6.3', title: '重点强化——β-内酰胺类药物总结', importance: 5 },
      ]},
      { code: '9.7', title: '第七节 氨基糖苷类抗菌药物', children: [
        { code: '9.7.1', title: '考点1 代表药品与作用机制', importance: 5 },
        { code: '9.7.2', title: '考点2 药物临床用药评价', importance: 5 },
      ]},
      { code: '9.8', title: '第八节 四环素类抗菌药物', children: [
        { code: '9.8.1', title: '考点1 代表药品与作用机制', importance: 4 },
        { code: '9.8.2', title: '考点2 药物临床用药评价', importance: 4 },
        { code: '9.8.3', title: '重点强化——作用于30S亚基的药物', importance: 4 },
      ]},
      { code: '9.9', title: '第九节 大环内酯类抗菌药物', children: [
        { code: '9.9.1', title: '考点1 药物分类与作用机制', importance: 5 },
        { code: '9.9.2', title: '考点2 药物临床用药评价', importance: 5 },
      ]},
      { code: '9.10', title: '第十节 林可霉素类抗菌药物', children: [
        { code: '9.10.1', title: '考点1 代表药品与作用机制', importance: 4 },
        { code: '9.10.2', title: '考点2 药物临床用药评价', importance: 4 },
      ]},
      { code: '9.11', title: '第十一节 酰胺醇类抗菌药物', children: [
        { code: '9.11.1', title: '考点1 代表药品与作用机制', importance: 4 },
        { code: '9.11.2', title: '考点2 药物临床用药评价', importance: 4 },
        { code: '9.11.3', title: '重点强化——作用于50S亚基的药物', importance: 4 },
      ]},
      { code: '9.12', title: '第十二节 喹诺酮类抗菌药物', children: [
        { code: '9.12.1', title: '考点1 药物分类与作用机制', importance: 5 },
        { code: '9.12.2', title: '考点2 药物临床用药评价', importance: 5 },
      ]},
      { code: '9.13', title: '第十三节 磺胺类抗菌药物', children: [
        { code: '9.13.1', title: '考点1 药物分类与代表药品', importance: 4 },
        { code: '9.13.2', title: '考点2 药物临床用药评价', importance: 4 },
        { code: '9.13.3', title: '重点强化——影响核酸/叶酸合成的药物', importance: 4 },
      ]},
      { code: '9.14', title: '第十四节 糖肽类抗菌药物', children: [
        { code: '9.14.1', title: '考点1 代表药品与作用机制', importance: 5 },
        { code: '9.14.2', title: '考点2 药物临床用药评价', importance: 5 },
      ]},
      { code: '9.15', title: '第十五节 其他抗菌药物', children: [
      ...
      { code: '9.16', title: '第十六节 硝基呋喃类抗菌药物', children: [
        { code: '9.16.1', title: '考点1 代表药品与作用机制', importance: 3 },
        { code: '9.16.2', title: '考点2 药物临床用药评价', importance: 3 },
      ]},
      { code: '9.17', title: '第十七节 硝基咪唑类抗菌药物', children: [
        { code: '9.17.1', title: '考点1 代表药品与作用机制', importance: 5 },
        { code: '9.17.2', title: '考点2 药物临床用药评价', importance: 5 },
        { code: '9.17.3', title: '重点强化——其他类药物总结', importance: 4 },
      ]},
      { code: '9.18', title: '第十八节 抗结核分枝杆菌药', children: [
        { code: '9.18.1', title: '考点1 药物分类与代表药品', importance: 5 },
      ...
      { code: '9.19', title: '第十九节 抗真菌药', children: [
        { code: '9.19.1', title: '考点1 药物分类与代表药品', importance: 5 },
      ...
      { code: '9.20', title: '第二十节 抗疱疹病毒药物', children: [
        { code: '9.20.1', title: '考点1 药物分类与代表药品', importance: 4 },
        { code: '9.20.2', title: '考点2 药物临床用药评价', importance: 4 },
      ]},
      { code: '9.21', title: '第二十一节 抗流感病毒药', children: [
        { code: '9.21.1', title: '考点1 药物分类与代表药品', importance: 5 },
      ...
      { code: '9.22', title: '第二十二节 抗新型冠状病毒药', children: [
        { code: '9.22.1', title: '考点1 药物分类与代表药品', importance: 4 },
      ]},
      { code: '9.23', title: '第二十三节 抗肝炎病毒药物', children: [
        { code: '9.23.1', title: '考点1 药物分类与代表药品', importance: 5 },
      ...
      { code: '9.24', title: '第二十四节 抗艾滋病病毒药物', children: [
        { code: '9.24.1', title: '考点1 药物分类与代表药品', importance: 4 },
        { code: '9.24.2', title: '考点2 药物临床用药评价', importance: 4 },
        { code: '9.24.3', title: '重点强化——抗病毒药的分类与代表药品', importance: 4 },
      ]},
      { code: '9.25', title: '第二十五节 抗原虫药', children: [
        { code: '9.25.1', title: '考点1 药物分类与代表药品', importance: 4 },
        { code: '9.25.2', title: '考点2 抗原虫药的临床用药评价', importance: 4 },
        { code: '9.25.3', title: '考点3 抗疟药的临床用药评价', importance: 4 },
      ]},
      { code: '9.26', title: '第二十六节 抗蠕虫药', children: [
        { code: '9.26.1', title: '考点1 药物分类与代表药品', importance: 4 },
...

  {
    ...
    title: '第十章 抗肿瘤药',
    children: [
      { code: '10.1', title: '第一节 直接影响DNA结构和功能的药物', children: [
        { code: '10.1.1', title: '考点1 药物分类与代表药品', importance: 5 },
      ...
      { code: '10.2', title: '第二节 干扰核酸生物合成的药物（抗代谢药）', children: [
        { code: '10.2.1', title: '考点1 药物分类与代表药品', importance: 5 },
        { code: '10.2.2', title: '考点2 抗代谢药的临床用药评价', importance: 5 },
      ]},
      { code: '10.3', title: '第三节 干扰转录过程和阻止RNA合成的药物', children: [
        { code: '10.3.1', title: '考点1 蒽环类抗肿瘤抗生素的临床用药评价', importance: 5 },
      ]},
      { code: '10.4', title: '第四节 干扰有丝分裂药物', children: [
        { code: '10.4.1', title: '考点1 药物分类与作用机制', importance: 5 },
        { code: '10.4.2', title: '考点2 长春碱类的临床用药评价', importance: 4 },
        { code: '10.4.3', title: '考点3 紫杉醇类的临床用药评价', importance: 5 },
      ]},
      { code: '10.5', title: '第五节 调节体内激素平衡的药物', children: [
        { code: '10.5.1', title: '考点1 药物分类与代表药品', importance: 5 },
        { code: '10.5.2', title: '考点2 抗雌激素类的临床用药评价', importance: 5 },
        { code: '10.5.3', title: '考点3 抗雄激素类的临床用药评价', importance: 4 },
        { code: '10.5.4', title: '考点4 GnRH激动剂/抑制剂的临床用药评价', importance: 4 },
        { code: '10.5.5', title: '重点强化——调节激素平衡抗肿瘤药适应证', importance: 4 },
      ]},
      { code: '10.6', title: '第六节 生物靶向治疗药物', children: [
        { code: '10.6.1', title: '考点1 药物分类与代表药品', importance: 5 },
      ...
      { code: '10.7', title: '第七节 其他抗肿瘤药物', children: [
        { code: '10.7.1', title: '考点1 药物分类与代表药品', importance: 3 },
  ...
  },
  {
    ...
    children: [
      { code: '11.1', title: '第一节 糖类、盐类、酸碱平衡调节药', children: [
      ...
      { code: '11.2', title: '第二节 微量元素与维生素', children: [
      ...
      { code: '11.3', title: '第三节 肠内营养药', children: [
        { code: '11.3.1', title: '考点1 药物分类与代表药品', importance: 3 },
        { code: '11.3.2', title: '考点2 肠内营养粉剂的临床用药评价', importance: 3 },
        { code: '11.3.3', title: '考点3 肠内营养乳剂的临床用药评价', importance: 3 },
      ]},
      { code: '11.4', title: '第四节 肠外营养药', children: [
...
async function insertNode(client, node, parentId, level, sortOrder) {
  let nodeType
  ...
  // 生成唯一ID
  const nodeId = `${SUBJECT_CODE}-${node.code}`
    ...
    for (let i = 0; i < knowledgeTree.length; i++) {
      ...
      if (chapter.children) {
        for (const section of chapter.children) {
          totalSections++
          if (section.children) {
            totalPoints += section.children.length
          }
        }
      }
    }
