...
async function main() {
  try {
    console.log('开始导入2023年执业药师中药学综合知识与技能真题...\n');

    // 读取JSON数据
    const jsonPath = path.join(__dirname, 'shuju', '2023年执业药师中药师药学综合与技能历年真题.json');
    ...
    console.log(`数据库中2023年题目总数: ${total} 道\n`);
